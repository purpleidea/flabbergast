...
final class ListReplicaSets
    extends BaseKubernetesNamespacedListOperation<ReplicaSet, ReplicaSetList> {

  @Override
  protected Operation<ReplicaSet, ReplicaSetList, ?, ?> invokeNamespace(KubernetesClient client)
      throws KubernetesClientException {
    return client.apps().replicaSets();
  }

  @Override
  protected List<ReplicaSet> items(ReplicaSetList list) {
    return list.getItems();
  }

  @Override
  protected void populate(List<Attribute> builder, ReplicaSet item) {
