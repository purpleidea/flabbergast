...
class FieldValue extends LoadableValue {
  ...
  public FieldValue(Field field) {
    this(getInternalName(field.getDeclaringClass()), field.getName(), field.getType());
  }
  ...
  public void load(MethodVisitor generator) {
    ...
    generator.visitFieldInsn(Opcodes.GETFIELD, class_name, name, Type.getDescriptor(type));
  }
  ...
  public void store(MethodVisitor generator) {
    generator.visitFieldInsn(Opcodes.PUTFIELD, class_name, name, Type.getDescriptor(type));
  }
}
