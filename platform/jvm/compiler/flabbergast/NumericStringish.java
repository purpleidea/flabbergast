...
class NumericStringish extends LoadableValue {
  ...
  public void load(MethodVisitor generator) throws Exception {
    generator.visitTypeInsn(Opcodes.NEW, getInternalName(SimpleStringish.class));
    generator.visitInsn(Opcodes.DUP);
    source.load(generator);
    generator.visitMethodInsn(
        Opcodes.INVOKESTATIC,
        getInternalName(Generator.getBoxedType(source.getBackingType())),
        "toString",
        Generator.makeSignature(String.class, source.getBackingType()));
