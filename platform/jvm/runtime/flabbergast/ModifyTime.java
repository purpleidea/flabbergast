...
public class ModifyTime extends BaseMapFunctionInterop<ZonedDateTime, ZonedDateTime> {
    ...
    public ModifyTime(TaskMaster task_master, SourceReference source_ref,
                      Context context, Frame self, Frame container) {
        super(ZonedDateTime.class, ZonedDateTime.class, task_master, source_ref, context, self, container);
    }
    ...
    protected ZonedDateTime computeResult(ZonedDateTime initial) {
        return initial.plus((int) milliseconds, ChronoUnit.MILLIS)
