...
public class EscapeRangeBuilder extends BaseReflectedInterop<Transformation> {
    ...
    protected void setup() {
        ...
        ListSink<RangeAction> actions_lookup = findAll(RangeAction.class, x-> actions = new ArrayList<>(x.values()));
        actions_lookup.allowDefault(false, "Frame is not one of the Unicode escapes known.");
        actions_lookup.allow(String.class, str -> (buffer, codepoint) -> buffer.append(str), false, null);
