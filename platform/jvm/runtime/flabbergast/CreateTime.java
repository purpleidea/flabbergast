...
public class CreateTime extends BaseFunctionInterop<ZonedDateTime> {
    ...
    public CreateTime(TaskMaster task_master, SourceReference source_ref,
    ...
    protected void setup() {
        ...
        month_obj.add(Long.class, "ordinal", false, Ptr::set, "Can only use a frame from the “months” frame.");
    ...
    protected ZonedDateTime computeResult() {
        return ZonedDateTime.of((int) year, (int) month, (int) day,
