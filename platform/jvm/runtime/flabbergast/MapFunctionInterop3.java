...
public class MapFunctionInterop3<T1, T2, T3, R> extends BaseMapFunctionInterop<T1, R> {
    ...
    public MapFunctionInterop3(Class<R> returnClass, Class<T1> clazz, Func3<T1, T2, T3, R> func, Class<T2> parameter1Clazz, boolean parameter1Nullable,  String parameter1, Class<T3> parameter2Clazz, boolean parameter2Nullable, String parameter2, TaskMaster task_master, SourceReference source_reference,
