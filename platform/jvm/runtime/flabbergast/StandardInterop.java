...
public class StandardInterop extends Interop {
  ...
  private StandardInterop() {
    ...
    addMap(
        ...
        Double.class,
        "math/circle/arccos",
        (x, angle_unit) -> Math.acos(x) / angle_unit,
        Double.class,
        "angle_unit");
    addMap(
        Double.class,
        Double.class,
        "math/circle/arcsin",
        (x, angle_unit) -> Math.asin(x) / angle_unit,
        Double.class,
        "angle_unit");
    addMap(
        Double.class,
        Double.class,
        "math/circle/arctan",
        (x, angle_unit) -> Math.atan(x) / angle_unit,
        Double.class,
        "angle_unit");
    addMap(
        Double.class,
        Double.class,
        "math/circle/cos",
        (x, angle_unit) -> Math.cos(x * angle_unit),
        Double.class,
        "angle_unit");
    addMap(
        Double.class,
        Double.class,
        "math/circle/sin",
        (x, angle_unit) -> Math.sin(x * angle_unit),
        Double.class,
        "angle_unit");
    addMap(
        Double.class,
        Double.class,
        "math/circle/tan",
        (x, angle_unit) -> Math.tan(x * angle_unit),
        Double.class,
        "angle_unit");
    ...
    addMap(
        ...
        (x, angle_unit) -> Math.log(x + Math.sqrt(x * x - 1.0)) / angle_unit,
        Double.class,
        "angle_unit");
    addMap(
        Double.class,
    ...
    addMap(
        ...
        (x, angle_unit) -> 0.5 * Math.log((1.0 + x) / (1.0 - x)) / angle_unit,
        Double.class,
        "angle_unit");
    addMap(
        Double.class,
        Double.class,
        "math/hyperbola/cos",
        (x, angle_unit) -> Math.cosh(x * angle_unit),
        Double.class,
        "angle_unit");
    addMap(
        Double.class,
        Double.class,
        "math/hyperbola/sin",
        (x, angle_unit) -> Math.sinh(x * angle_unit),
        Double.class,
        "angle_unit");
    addMap(
        Double.class,
        Double.class,
        "math/hyperbola/tan",
        (x, angle_unit) -> Math.tanh(x * angle_unit),
        Double.class,
        "angle_unit");
    addMap(
        Double.class,
    ...
    add(
        ...
        (epoch, is_utc) ->
            ZonedDateTime.ofInstant(
                Instant.ofEpochSecond(epoch), is_utc ? ZoneId.of("Z") : ZoneId.systemDefault()),
        Long.class,
        "epoch",
        Boolean.class,
        "is_utc");
    add("time/modify", ModifyTime::new);
    add("time/months", new FixedFrame("months", time_src).add(InterlockedLookup.MONTHS));
    add(
        "time/now/local",
        ReflectedFrame.create("now_local", ZonedDateTime.now(), InterlockedLookup.TIME_ACCESSORS));
    add(
        "time/now/utc",
        ReflectedFrame.create(
            "now_utc", ZonedDateTime.now(ZoneId.of("Z")), InterlockedLookup.TIME_ACCESSORS));
    addMap(
        ZonedDateTime.class,
        ZonedDateTime.class,
        "time/switch_zone",
        (initial, to_utc) ->
            initial.withZoneSameInstant(to_utc ? ZoneId.of("Z") : ZoneId.systemDefault()),
        Boolean.class,
        "to_utc");
    addMap(byte[].class, byte[].class, "utils/bin/compress/gzip", BinaryFunctions::compress);
    addMap(
        byte[].class, String.class, "utils/bin/from/base64", DatatypeConverter::parseBase64Binary);
    addMap(
        byte[].class, byte[].class, "utils/bin/hash/md5", x -> BinaryFunctions.checksum(x, "MD5"));
    addMap(
        byte[].class,
        byte[].class,
        "utils/bin/hash/sha1",
    ...
    addMap(
        ...
        (x, allow_unassigned) -> IDN.toUnicode(x, (allow_unassigned ? IDN.ALLOW_UNASSIGNED : 0)),
        Boolean.class,
        "allow_unassigned");
    addMap(
        String.class,
        ...
        (x, allow_unassigned, strict_ascii) ->
            IDN.toASCII(
                x,
                (allow_unassigned ? IDN.ALLOW_UNASSIGNED : 0)
                    | (strict_ascii ? IDN.USE_STD3_ASCII_RULES : 0)),
        Boolean.class,
        "allow_unassigned",
        Boolean.class,
        "strict_ascii");
    ...
    addMap(
        Boolean.class, String.class, "utils/str/prefixed", String::startsWith, String.class, "str");
    addMap(
        String.class,
        String.class,
        "utils/str/replace",
    ...
    addMap(
        ...
        "length");
    addMap(
        Boolean.class, String.class, "utils/str/suffixed", String::endsWith, String.class, "str");
