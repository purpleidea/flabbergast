...
public class JdbcQuery extends BaseFunctionInterop<Frame> {
    ...
    static {
        ...
        addUnpacker(new Unpacker() {
            ...
            Object invoke(ResultSet rs, int position, TaskMaster task_master)
            throws SQLException {
                return ReflectedFrame.create(task_master,
    ...
    public JdbcQuery(TaskMaster task_master, SourceReference source_reference,
    ...
    public Frame computeResult() throws Exception {
        ...
        MutableFrame list = new MutableFrame(task_master, source_reference,
                                             context, self);
