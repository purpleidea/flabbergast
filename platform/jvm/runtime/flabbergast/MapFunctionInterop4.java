...
public class MapFunctionInterop4<T1, T2, T3, T4, R> extends BaseMapFunctionInterop<T1, R> {
    ...
    public MapFunctionInterop4(Class<R> returnClass, Class<T1> clazz, Func4<T1, T2, T3, T4, R> func, Class<T2> parameter1Clazz, boolean parameter1Nullable, String parameter1, Class<T3> parameter2Clazz, boolean parameter2Nullable, String parameter2, Class<T4> parameter3Clazz, boolean parameter3Nullable, String parameter3, TaskMaster task_master, SourceReference source_reference,
