...
namespace Flabbergast
{
    ...
    public class MergeIterator
    {
        ...
        public Stringish Currentish => new SimpleStringish(enumerator.Current.Key);
    ...
    public class OrderByIterator<T>
    {
        ...
        private readonly IEnumerator<string> setup_enumerator;
        ...
        public Stringish Currentish => new SimpleStringish(Current);
