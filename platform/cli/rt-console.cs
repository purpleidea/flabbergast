...
namespace Flabbergast
{
    ...
    public class PrintResult : Future
    {
        ...
        private void HandleFinalResult(object result)
        {
            ...
            {
                Console.Error.WriteLine("Cowardly refusing to print result of type {0}.",
                    SupportFunctions.NameForType(result.GetType()));
            }
        }
        ...
        private void HandleFrameResult(object result)
        {
            ...
            if (frame != null)
            {
                var lookup = new Lookup(task_master, new NativeSourceReference("printer"), new[] { "value" },
                    frame.Context);
