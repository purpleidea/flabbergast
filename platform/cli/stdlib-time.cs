...
{
    internal class CreateTime : BaseFunctionInterop<DateTime>
    {
        private long day;
        private long hour;
        ...
        public CreateTime(TaskMaster task_master, SourceReference source_ref, Context context, Frame self,
            Frame container) : base(task_master, source_ref, context, self, container)
        {
        }

        private void Add<T>(string name, Action<T> writer)
        {
            var lookup = Find(writer);
        ...
        protected override DateTime ComputeResult()
        {
            return new DateTime((int)year, (int)month, (int)day, (int)hour, (int)minute, (int)second,
                (int)millisecond, kind);
        }
    }

    internal class ModifyTime : BaseMapFunctionInterop<DateTime, DateTime>
    {
        private long days;
        private long hours;
        ...
        public ModifyTime(TaskMaster task_master, SourceReference source_ref, Context context, Frame self,
            Frame container) : base(task_master, source_ref, context, self, container)
        {
        }
