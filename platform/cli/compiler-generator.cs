...
namespace Flabbergast
{
    ...
    public class CompilationUnit
    {
        ...
        public IEnumerable<string> ExternalUris
        {
            get
            {
    ...
    internal abstract class Generator
    {
         ...
         */
        public System.Diagnostics.SymbolStore.ISymbolDocumentWriter SymbolDocument
        {
            get;
            private set;
        }
        ...
        private void CopyField(LoadableValue source, FieldInfo target)
        {
            Builder.Emit(OpCodes.Ldarg_0);
    ...
    internal class DefinitionGenerator : Generator
    {
         ...
         */
        public MethodBuilder Initialiser
        {
            get;
            private set;
        }
         ...
         */
        public FieldValue InitialSourceReference
        {
            get;
            private set;
        }
         ...
         */
        public FieldValue InitialContext
        {
            get;
            private set;
        }
         ...
         */
        public FieldValue InitialSelfFrame
        {
            get;
            private set;
        }
         ...
         */
        public FieldValue InitialContainerFrame
        {
            get;
            private set;
        }
         ...
         */
        public FieldValue InitialOriginal
        {
            get;
            private set;
        }
    ...
    internal class ReplGenerator : Generator
    {
        internal FieldValue RootFrame
        {
            get;
            private set;
        }
        internal FieldValue CurrentFrame
        {
            get;
            private set;
        }
        internal FieldValue UpdateCurrent
        {
            get;
            private set;
        }
        internal FieldValue EscapeValue
        {
            get;
            private set;
        }
        internal FieldValue PrintValue
        {
            get;
            private set;
        }
    ...
    internal class LookupCache
    {
        ...
        public LoadableValue this[NameInfo name_info]
        {
            ...
            set
            {
                defined_values[name_info] = value;
            }
        }
    ...
    internal abstract class LoadableValue
    {
        ...
        public abstract System.Type BackingType
        {
            get;
        }
    ...
    {
        public override System.Type BackingType
        {
            get
            {
                return backing;
    ...
    internal class MatchedFrameValue : LoadableValue
    {
        ...
        private readonly LoadableValue array;
    ...
    internal class GeneratedValue : LoadableValue
    {
        ...
        private readonly System.Type type;
        private readonly GenerationBlock block;
