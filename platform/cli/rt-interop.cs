...
namespace Flabbergast
{
    ...
    public class FunctionInterop<T, R> : BaseFunctionInterop<R>
    {
        ...
        {
            var input_lookup = Find<T>(x => input = x);
    ...
    public class FunctionInterop<T1, T2, R> : BaseFunctionInterop<R>
    {
        ...
        public FunctionInterop(Func<T1, T2, R> func, string parameter1, string parameter2, TaskMaster task_master,
        ...
        protected override void Setup()
        {
            var input1_lookup = Find<T1>(x => input1 = x);
            input1_lookup.AllowDefault();
            input1_lookup.Lookup(parameter1);
            var input2_lookup = Find<T2>(x => input2 = x);
    ...
    public class MapFunctionInterop<T1, T2, R> : BaseMapFunctionInterop<T1, R>
    {
        ...
        public MapFunctionInterop(Func<T1, T2, R> func, string parameter, TaskMaster task_master,
            SourceReference source_ref,
            Context context, Frame self, Frame container) : base(task_master, source_ref, context, self, container)
        {
            this.func = func;
        ...
        {
            var ref_lookup = Find<T2>(x => reference = x);
    ...
    public class MapFunctionInterop<T1, T2, T3, R> : BaseMapFunctionInterop<T1, R>
    {
        ...
        public MapFunctionInterop(Func<T1, T2, T3, R> func, string parameter1, string parameter2,
            TaskMaster task_master, SourceReference source_ref,
            Context context, Frame self, Frame container) : base(task_master, source_ref, context, self, container)
        {
            this.func = func;
            this.parameter1 = parameter1;
        ...
        protected override void SetupExtra()
        {
            var ref1_lookup = Find<T2>(x => reference1 = x);
            ref1_lookup.AllowDefault();
            ref1_lookup.Lookup(parameter1);
            var ref2_lookup = Find<T3>(x => reference2 = x);
    ...
    public class MapFunctionInterop<T1, T2, T3, T4, R> : BaseMapFunctionInterop<T1, R>
    {
        ...
        private readonly string parameter1;
        private readonly string parameter2;
        private readonly string parameter3;
        private T2 reference1;
        private T3 reference2;
        private T4 reference3;

        public MapFunctionInterop(Func<T1, T2, T3, T4, R> func, string parameter1, string parameter2, string parameter3,
            TaskMaster task_master, SourceReference source_ref,
            Context context, Frame self, Frame container) : base(task_master, source_ref, context, self, container)
        {
            this.func = func;
        ...
        protected override void SetupExtra()
        {
            ...
            ref2_lookup.AllowDefault();
            ref2_lookup.Lookup(parameter2);
            var ref3_lookup = Find<T4>(x => reference3 = x);
