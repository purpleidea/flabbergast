...
namespace Flabbergast
{
    ...
    internal class OverrideNameInfo : RestrictableType
    {
        ...
        public override LoadableCache Load(Generator generator, LoadableValue source_reference, LoadableValue context)
        {
            return new LoadableCache(((DefinitionGenerator)generator).InitialOriginal, RealType, this, must_unbox);
        }
    }
    ...
    {
        private readonly Environment Environment;
        private readonly ITypeableElement Target;
        private bool must_unbox;
        public override Type RestrictedType
        {
            get
    ...
    {
        private readonly Environment Environment;
        private readonly NameInfo Source;
        private Type Mask = AnyType;
        private bool must_unbox;
    ...
    internal class Environment : CodeRegion
    {
        ...
        private readonly Dictionary<string, NameInfo> Children = new Dictionary<string, NameInfo>();
        private readonly Dictionary<AstNode, Tuple<Type, bool>> Intrinsics = new Dictionary<AstNode, Tuple<Type, bool>>();
        ...
        private readonly bool top_level;
        private readonly bool ForceBack;
        private bool combinatorial_explosion;
