...
namespace Flabbergast {
	public class Completables {
		private readonly string[] keywords = {"args", "value", "Bool", "By", "Container", "Each", "Else", "Enforce", "Error", "False", "Finite", "Float", "FloatMax", "FloatMin", "For", "Frame", "From", "GenerateId", "Id", "If", "In", "Infinity", "Int", "IntMax", "IntMin", "Is", "Length", "Let", "Lookup", "NaN", "Name", "Null", "Order", "Ordinal", "Reduce", "Reverse", "Select", "Str", "Template", "Then", "This", "Through", "To", "True", "Where", "With"};
